...
const logoSvg = `<svg xmlns='http://www.w3.org/2000/svg' width='400' height='120' viewBox='0 0 400 120'>
  <style>
    .badge { fill: #c0252d; }
    .badge-text { fill: white; font-family: 'Malgun Gothic','Noto Sans KR',sans-serif; font-weight: 900; font-size: 36px; }
    .main { fill: #111; font-family: 'Malgun Gothic','Noto Serif KR',serif; font-weight: 900; font-size: 56px; letter-spacing: -2px; }
  </style>
  <rect x='10' y='15' width='70' height='90' rx='6' class='badge'/>
  <text x='45' y='52' text-anchor='middle' class='badge-text'>매</text>
  <text x='45' y='94' text-anchor='middle' class='badge-text'>일</text>
  <text x='95' y='82' class='main'>백세한의원</text>
</svg>`;
