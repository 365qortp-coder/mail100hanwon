...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "매일백세한의원 사향공진단. CITES 부속서 I 인증 천연 사향 100mg 함유. 30구 135만원, 100구 350만원. 기력·뇌기능·남성 스태미너. 원장이 유튜브에 조제 전과정 공개. 0507-1467-0195.",
...
const faqs = [
  ...
  {
    q: "비대면으로 처방받을 수 있나요?",
    a: "가능합니다. 카카오톡 또는 전화(0507-1467-0195) 문의 → 구글 설문지 작성 → 송원석 원장 직접 전화 상담 → 원내 직접 조제 후 전국 택배 발송(영업일 2~5일). 재진 환자는 절차가 더 간소화됩니다.",
  },
];
