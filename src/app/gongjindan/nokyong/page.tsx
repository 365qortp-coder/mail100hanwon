...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "매일백세한의원 녹용 2배 공진단. 일반 공진단 대비 녹용 2배 함량. 30구 42만원, 120구 120만원. 수술 후·항암 후 체력 회복, 어르신·갱년기 면역력. 원장 직접 조제. 0507-1467-0195.",
...
const faqs = [
  ...
  {
    q: "비대면으로 처방받을 수 있나요?",
    a: "가능합니다. 카카오톡 또는 전화(0507-1467-0195) 문의 → 구글 설문지 작성 → 송원석 원장 직접 전화 상담 → 원내 직접 조제 후 전국 택배 발송(영업일 2~5일).",
  },
];
